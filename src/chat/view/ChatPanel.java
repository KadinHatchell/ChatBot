 ...
 */
	public ChatPanel(ChatController baseController)
	{
		...
		chatButton = new JButton("Press to Chat");
	...
	private void setupLayout()
	{
		...
		baseLayout.putConstraint(SpringLayout.NORTH, chatPane, 15, SpringLayout.SOUTH, chatLabel);
		baseLayout.putConstraint(SpringLayout.WEST, chatPane, 0, SpringLayout.WEST, chatButton);
		baseLayout.putConstraint(SpringLayout.SOUTH, chatPane, -6, SpringLayout.NORTH, chatField);
		baseLayout.putConstraint(SpringLayout.EAST, chatPane, 0, SpringLayout.EAST, chatButton);
		baseLayout.putConstraint(SpringLayout.WEST, postButton, 8, SpringLayout.EAST, searchButton);
		baseLayout.putConstraint(SpringLayout.WEST, chatButton, 0, SpringLayout.WEST, searchButton);
		baseLayout.putConstraint(SpringLayout.EAST, chatButton, 430, SpringLayout.WEST, searchButton);
		baseLayout.putConstraint(SpringLayout.NORTH, searchButton, 0, SpringLayout.NORTH, saveButton);
		baseLayout.putConstraint(SpringLayout.WEST, searchButton, 10, SpringLayout.WEST, this);
		baseLayout.putConstraint(SpringLayout.NORTH, chatField, 167, SpringLayout.NORTH, this);
		...
		baseLayout.putConstraint(SpringLayout.WEST, chatLabel, 165, SpringLayout.WEST, this);
		baseLayout.putConstraint(SpringLayout.SOUTH, openButton, -5, SpringLayout.NORTH, saveButton);
		baseLayout.putConstraint(SpringLayout.EAST, openButton, 0, SpringLayout.EAST, saveButton);
		...
		baseLayout.putConstraint(SpringLayout.EAST, postButton, -226, SpringLayout.WEST, saveButton);
